 ...
 *
 */
public class StreamTest10_partitioningBy_partitioningBy {
    ...
    public static void main(String[] args) {
        ...
        Map<Boolean,Map<Boolean,List<Student>>> map = students.stream().collect(partitioningBy(student -> student.getAge() > 80 ,partitioningBy(student -> student.getAge() > 90)));
