 ...
 *
 */
public class StreamTest12_partitioningBy_sumingInt {
    ...
    public static void main(String[] args) {
        ...
        Map<Boolean,Integer> map = students.stream().collect(partitioningBy(student -> student.getAge() > 80,summingInt(student->student.getAge())));
