 ...
 *
 */
public class StreamTest13_groupingBy_collectingAndThen_minBy {
    ...
    public static void main(String[] args) {
        ...
        //以名字进行分组，并且查找年龄最小的学生
        Map<String,Student> map = students.stream().collect(groupingBy(Student::getName,collectingAndThen(minBy(Comparator.comparingInt(Student::getAge)), Optional::get)));
