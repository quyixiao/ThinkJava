 ...
 *
 */
public class StreamTest3_maxBy {
    ...
    public static void main(String[] args) {
        ...
        students.stream().collect(maxBy((Comparator.comparingInt(Student::getAge))))
                .ifPresent(System.out::println);

        Student student = students.stream().collect(maxBy((Comparator.comparingInt(Student::getAge)))).get();
