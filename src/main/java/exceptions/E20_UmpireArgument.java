 ...
 *
 *  271页
 * 修改StorymyInning.java。加一个UmpireArgument异常，和一个能抛出此异常的方法
 * ，测试一下修改异常继承体系
 *
 *
 *
...
public class E20_UmpireArgument {
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.println("Generic error 111111111");
        }
        ...
        try {
            ...
            System.out.println("Generic baseball exception 222222222");
        }
        ...
        try {
            ...
            System.out.println("Argument with the umpire       3333333");
        } catch (BaseballException e) {
